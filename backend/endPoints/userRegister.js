...
const Register = async (req, res, next) => {
  ...
  try {
    ...
    const malePic = `https://avatar.iran.liara.run/public/boy?profileName=${profileName}`;
    const femalePic = `https://avatar.iran.liara.run/public/girl?profileName=${profileName}`;
